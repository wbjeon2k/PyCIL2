...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn1 = norm_layer(planes, track_running_stats=True, eps=2.0)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes)
        self.bn2 = norm_layer(planes, track_running_stats=True, eps=2.0)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn1 = norm_layer(width, track_running_stats=True, eps=2.0)
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.bn2 = norm_layer(width, track_running_stats=True, eps=2.0)
        self.conv3 = conv1x1(width, planes * self.expansion)
        self.bn3 = norm_layer(planes * self.expansion, track_running_stats=True, eps=2.0)
        self.relu = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.stride = stride
        ...
        if 'cifar' in args["dataset"]:
            if args["model_name"] == "memo":
                self.conv1 = nn.Sequential(
                    ...
                    nn.BatchNorm2d(self.inplanes, track_running_stats=True, eps=2.0),
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                norm_layer(planes * block.expansion , track_running_stats=True, eps=2.0),
            )
