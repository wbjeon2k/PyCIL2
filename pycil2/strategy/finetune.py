...
class Finetune(BaseLearner):
    """Finetune strategy for class-incremental learning.
    ...
    def after_task(self):
        """Update known classes count after a task is completed."""
    ...
    def _train(self, train_loader, test_loader):
        ...
        if self._cur_task == 0:
            # Initial task training with standard parameters
            optimizer = optim.SGD(
            ...
            # Subsequent tasks with different parameters
            optimizer = optim.SGD(
                self._network.parameters(),
                lr=self.args["lrate"],
                momentum=0.9,
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        """Training procedure for subsequent tasks, focusing on new classes.
